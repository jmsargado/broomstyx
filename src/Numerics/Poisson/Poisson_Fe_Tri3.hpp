...
namespace broomstyx
{
    ...
    class NS_Poisson_Fe_Tri3 final : public NumericsStatus
    {
        friend class Poisson_Fe_Tri3;
        
    public:
        NS_Poisson_Fe_Tri3();
        ~NS_Poisson_Fe_Tri3() override;
    ...
    private:
        ...
        NS_Poisson_Fe_Tri3* getNumericsStatusAt( Cell* targetCell );
        RealMatrix giveBmatAt( Cell* targetCell );
        RealMatrix giveJacobianMatrixAt( Cell* targetCell, const RealVector& natCoor );
        static RealVector giveLocalValuesAt( std::vector<Dof*>& dof, ValueType valType );
