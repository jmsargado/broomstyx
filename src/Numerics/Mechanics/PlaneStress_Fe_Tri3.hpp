...
#ifndef PLANESTRESS_FE_TRI3_HPP
#define	PLANESTRESS_FE_TRI3_HPP
...
namespace broomstyx
{
    ...
    class NumericsStatus_PlaneStress_Fe_Tri3 final : public NumericsStatus
    {
        friend class PlaneStress_Fe_Tri3;
        
    public:
        NumericsStatus_PlaneStress_Fe_Tri3();
        virtual ~NumericsStatus_PlaneStress_Fe_Tri3();
    ...
    class PlaneStress_Fe_Tri3 final : public Numerics
    {
    public:
        PlaneStress_Fe_Tri3();
        virtual ~PlaneStress_Fe_Tri3();
